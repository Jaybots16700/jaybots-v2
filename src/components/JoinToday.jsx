          ...
          <div className="mx-auto flex max-w-2xl flex-col gap-16 bg-white/10 px-6 py-16 ring-1 ring-white/20 sm:rounded-3xl sm:p-8 xl:mx-0 xl:max-w-none xl:flex-row xl:items-center xl:gap-x-20 xl:px-20 xl:py-20">
            ...
            <div className="w-full flex-auto">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-300">
                Unleash your potential and join the Jaybots for an exhilarating
                journey of innovation, collaboration, and personal growth, where
                creativity thrives, skills sharpen, and lifelong friendships
                flourish amidst the exciting realm of technology and robotics.
              </p>
              <ul
                role="list"
